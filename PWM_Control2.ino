 ...
 ************************************************************************************************************************/
  ...
  // speed control input
  #define PIN_SPEED_0 12
  #define PIN_SPEED_1 13
 ...
 ************************************************************************************************************************/
  ...
  int pwm_ctr = 0;          // variable : pwm control value@loop
  ...
  int vth = 250;                // variable : target voltage value => 0V@0, 5.37V@100V, 10.30V@200, 20.19V@375
 ...
 ************************************************************************************************************************/
  int pidcontrol(int vth_goal, int vth_curr)
  {
    ...
    PID_control = constrain(PID_control, 0, 10);
 ...
 ************************************************************************************************************************/
  int pwm_ctrl()
  {
    //read voltage input, 약 voltage*20
